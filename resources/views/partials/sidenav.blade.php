<aside class="h-screen sticky top-0">
    <div class="w-60 h-screen flex-1 flex flex-col min-h-0 bg-blue-700">
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="mt-5 flex-1 px-2 space-y-1" aria-label="Sidebar">
                ...
                <a href="/process-payment" class="{{ (request()->is('process-payment*')) ? 'bg-blue-800 text-white' : 'text-indigo-100 hover:bg-indigo-600 hover:bg-opacity-75' }} flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <!-- Heroicon name: outline/chart-bar -->
