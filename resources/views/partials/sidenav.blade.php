    ...
    <div class="w-60 h-screen flex-1 flex flex-col min-h-0 bg-blue-500">
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="mt-5 flex-1 px-2 space-y-1" aria-label="Sidebar">
                ...
                <a href="/students" class="{{ (request()->is('students*')) ? 'bg-slate-600 text-white' : 'text-indigo-100 hover:bg-indigo-600 hover:bg-opacity-75' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <!-- Heroicon name: outline/chart-bar -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 flex-shrink-0 h-6 w-6 text-indigo-300 " viewBox="0 0 20 20" fill="currentColor bg-slate-600">
