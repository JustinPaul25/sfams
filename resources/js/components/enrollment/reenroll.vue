        ...
        <div class="py-6">
            <div class="sm:flex sm:items-center px-6">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl font-semibold text-gray-900">Reenroll Student</h1>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="bg-white shadow overflow-hidden">
                                        <div class="border-t border-gray-200">
                                            ...
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ student.father_is_deceased == '1' ? 'DECEASED' : 'LIVING' }}</dd>
                                            </div>
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                <dt class="text-sm font-medium text-gray-500"></dt>
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ student.mother_is_deceased == '1' ? 'DECEASED' : 'LIVING' }}</dd>
                                            </div>
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ student.guardian_phone }}</dd>
                                            </div>
                                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <aside class="block xl:col-span-4">
                <div class="sticky top-6 space-y-4">
                    <div class="bg-white p-4 rounded border border-blue-600">
                        ...
                        <h1 class="text-sm font-semibold text-blue-700 cursor-pointer hover:opacity-75">{{ gradeLevel() }}</h1>
                        ...
                        <ul role="list" class="-my-5 divide-y divide-gray-200">
                            ...
                            <div class="flex items-center space-x-1">
                                ...
                                <p class="text-gray-500">
                                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6"><polygon points="19 20 9 12 19 4 19 20"></polygon><line x1="5" y1="19" x2="5" y2="5"></line></svg>
                                </p>
                                </div>
                                ...
                                <div>
                                <p class="text-sm text-blue-700 truncate">₱ {{ numberWithCommas(student.account.back_account) }}</p>
                                </div>
                            </div>
    ...
    methods: {
        ...
        async processPayment() {
            ...
            if(this.form.section !== '') {
              ...
              this.print()
              await axios.post('/enrollment/old-student', this.form)
              .then(response => {
