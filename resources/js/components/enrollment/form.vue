                    ...
                    <div v-show="isOpen" :id="`collapse${_uid}`" class="p-5 font-light border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div v-if="requirements.good_moral">
                          <label class="inline-flex items-center mt-3">
                              <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" checked><span class="ml-2 text-gray-700">Good Moral</span>
                          </label>
                        </div>
            ...
            <div class="sticky top-6 space-y-4">
              <div class="bg-white p-4 rounded border border-blue-600">
                <div class="sm:flex-auto text-right">
                  ...
                  <h1 class="text-sm font-semibold text-blue-700 cursor-pointer hover:opacity-75">Requirements</h1>
                ...
                <div class="mt-6">
                  ...
                  <button @click="processPayment()" class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-white bg-blue-700 hover:bg-blue-500"> Enroll Student </button>
                </div>
              </div>
            </div>
          </aside>
...
<script>
  import _debounce from "lodash/debounce";
    ...
    export default {
        props: ['student', 'levels', 'fees', 'requirements'],
        data() {
          return {
            isOpen: false,
