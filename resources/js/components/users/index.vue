            ...
            <div class="grid grid-cols-8 gap-8 mt-8">
                <div class="col-span-8 sm:col-span-4 lg:col-span-2">
                    <div class="relative inline-block text-gray-700 w-full">
                        <input v-model="search" type="text" class="w-full h-10 pl-9 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500" placeholder="Search User">
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr v-for="user in users" class="hover:bg-blue-200">
                                ...
                                <td class="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 flex">
                                    ...
                                    <a @click="confirmDelete(user.id)" class="text-red-500 hover:text-red-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
export default {
    ...
    methods: {
        ...
        confirmDelete(id) {
            this.$swal.fire({
                title: 'Delete User?',
                text: "this action will permanent delete uesr account",
                icon: 'info',
