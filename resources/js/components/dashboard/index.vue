            ...
            <div class="bg-white shadow">
                ...
                <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                    ...
                    <div class="flex items-center">
                        <img class="hidden h-16 w-16 rounded-full sm:block" src="https://web.facebook.com/pbccmimainschool/photos/a.1920236288115137/3184922808313139/" alt="">
                        <div>
                        <div class="flex items-center">
                            <img class="h-16 w-16 rounded-full sm:hidden" src="https://web.facebook.com/pbccmimainschool/photos/a.1920236288115137/3184922808313139/" alt="">
