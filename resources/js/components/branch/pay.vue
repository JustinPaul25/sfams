                                ...
                                <ul role="list" class="-my-5 divide-y divide-gray-200">
                                    ...
                                    <li class="py-1">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate">Students Fees</p>
                                            </div>
                                            <div>
                                            <p class="text-sm text-blue-700 truncate">₱ {{ numberWithCommas(account.per_student_total) }}</p>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <p class="text-sm text-blue-700 truncate">₱ <input v-model="form.per_student_total" class="text-right" type="number"></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
