...
class EnrollmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $student = Student::create([
            ...
            'middle_name' => ucwords($request->input('middle_name')),
            ...
            'father_name' => ucwords($request->input('father_name')).' '.ucwords($request->input('last_name')),
            'father_is_deceased' => false,
            'father_phone' => $request->input('father_phone'),
            'mother_name' => ucwords($request->input('mother_name')).' '.ucwords($request->input('last_name')),
            ...
            'contact_person' => ucwords($request->input('contact_person')),
    ...
    public function enrollNewStudent(Request $request)
    {
        ...
        $user = User::create([
            'name' => ucwords($student->first_name).' '.ucwords($student->middle_name).' '.ucwords($student->last_name),
            'email' => $student->email,
